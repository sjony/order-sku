 ...
 */
public class OuterTaxi extends Taxi{
    ...
    public OuterTaxi() {
        ...
        //10公里以后每公里价钱
        this.afterTenPerKmPrice = new Double(2.5);
        ...
        //10公里以后每公里价钱
        this.afterTenPerKmPriceNight = new Double(3);
    ...
    public OuterTaxi(Double startingRoad, Double initiateRate, Double afterStartPerKmPrice, Double afterTenPerKmPrice, Double initiateRateNight, Double afterStartPerKmPriceNight,
